            ...
            <div className="card w-full px-10 shadow-2xl border">
              ...
              >
                ...
                <div className="form-control mt-6">
                  <button
                    type="submit"
                    className="text-2xl font-semibold text-white px-16 py-3 bg-slate-800 hover:bg-[#dc2626] rounded-lg hover:rounded-full"
                  >
                    Register
                  </button>
                </div>
                    ...
                    <NavLink
                      ...
                      className={({ isActive, isPending }) =>
                        isPending
                          ...
                          : isActive
                          ? "active"
                          : "text-2xl text-primary-content underline underline-offset-2 font-bold mx-2"
                      }
                    >
                      Login
                    </NavLink>
